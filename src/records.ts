        ...
        "tracks": [
            {
                "name": "Детство",
                "author": "Ласковый Май",
                description: "Когда тебе исполнилось три года, ты был у тёти на юбилее в ресторане. Был семейный ужин, и на тебя огромное впечатление произвела эта песня, и и ты её очень долго пел, и танцевал под неё на всех семейных мероприятиях. Можно сказать, что это твой первый трек на репите",
                "path": "./tracks/Laskovyj_Maj_-_Detstvo.mp3"
            },
            {
                "name": "Море, море",
                "author": "Юрий Антонов",
                description: "Когда тебе было пять лет, ты впервые с родителями поехал отдыхать на море в Алушту. Тогда ты впервые увидел море и горы. Это было, наверное, самое насыщенное и яркое впечатление того времени. И тогда ты пел эту песню, но вместо  «Море, море, мир бездонный», ты пел  «Море, море, мир бездомных»",
            ...
            },
            {
                ...
                description: "А это воспоминание о тебе от Вовы, потому что как только он слышит детские анимации, то всегда представляет тебя, потому что ты вспыхивал как спичка от этой музыки и с детской наивной улыбкой начинал отплясывать",
    ...
    "sideOne": {
        ...
        "tracks": [
            ...
            },
            {
                "name": "Два типа людей",
                "author": "Макс Корж",
                description: "Песня заслушенная до дыр в офисе, поэтому теперь это песня-воспоминание для Антона",
                "path": "./tracks/Maks_Korzh_-_2_tipa_lyudej.mp3"
            },
            {
                "name": "Где нас нет",
                "author": "Oxxxymiron",
                description: "Вы с Никитой пьяные на пару орали эту песню многократное количество раз, в том числе стоя на столе",
            ...
            },
            {
                ...
                "author": "Сироткин",
                description: "Этот трек посвящен свободе",
    ...
    "sideTwo": {
        ...
        "tracks": [
            ...
            },
            {
                "name": "Viva Kalman",
                "author": "Агата Кристи",
                description: "Мама тебя очень любит, поэтому добавила в список самую бесящую тебя песню, хоть и любимую для твоего папы, но мы знаем, что ты прошел путь от ненависти до любви и даже подпеваешь, когда она звучит",
            ...
            },
            {
                ...
                description: "Ты отрекся от массажа на 2 дня, лишь бы побесить Настю и спеть эту песню. У тебя есть возможность побесить её безвозмездно :) ",
    ...
    "sideOne": {
        ...
        "tracks": [
            ...
            },
            {
                ...
                "author": "Murray Head",
                description: "Песня-ассоциация от Динара, потому что это невероятно эпичный и слегка ретро-кринжовый трек про шахматный турнир. Он идеально описывает те моменты, когда вы планируете стратегию развития компании, словно разыгрываете сложную партию, где ставки высоки, а вокруг происходит безумие. Гроссмейстер горящей задницы делает ход конем",
                "path": "./tracks/Murray Head - One Night In Bangcock.mp3"
            },
            {
                "name": "Play God",
                "author": "Sam Fender",
                description: "Песня-ассоциация от Никиты, потому что ты тоже заслушал ее до дыр в офисе",
